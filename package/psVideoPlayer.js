export function videoPlayer(options){
  const { src, mute, autoplay } = options
...
const videoElement = document.querySelectorAll(".ps-video");
videoElement.forEach(element => {
  element.appendChild(videoPlayerDiv);
});

    console.log(document.querySelectorAll(".ps-video"))
